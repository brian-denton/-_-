 ...
 * Supports console, file, and Supabase database logging
 */
...
function createLogger() {
  ...
  // Supabase database transport (if enabled)
...
export function createRequestLogger(context: RequestContext) {
  return {
    ...
    http: (statusCode: number, responseTime: number, meta?: any) => {
...
export function logHttpRequest(
  ...
  logger.log(level, `${context.method} ${context.url} - ${statusCode} (${responseTime}ms)`, {
    ...context,
    statusCode: statusCode.toString(),
    responseTime: `${responseTime}ms`,
    ...additionalMeta,
